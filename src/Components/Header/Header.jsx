        ...
        if(!logged){
            return(
                <div className="action-buttons hide">
                    <Link to="/signin" title="Log in" className="secondary">
                        Sign in
                    </Link>
                    <Link to='/new-user' title="New acount" className="primary">
                        Create your account!
                    </Link>
                </div>
            )
            ...
            return(
                <div className="action-buttons hide">
                    ...
                    <span className="primary">{userInfo.Username}</span>
                </div>
            )
        }
    }
                                    ...
                                    <div className="dropdown">
                                        <ul className="list-items-with-description">
                                            <li>
                                                ...
                                                <h3><Link to='/movies'>List of Movies</Link></h3>
                                                    <p>List of movies in your favorite site</p>
                                                </div>
                                            </li>
                                            <li>
                                                <div className="icon-wrapper">
                                            ...
                                            <li>
                                                ...
                                                <div className="item-title">
                                                    <h3><Link to='/new-movie'>Add movies</Link></h3>
                                                    <p>Add a new movie into Database</p>
                                                </div>
                                            </li>
                                            <li>
                                                <div className="icon-wrapper">
